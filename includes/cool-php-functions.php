...
// SOURCE: http://www.jonasjohn.de/snippets/php/color-inverse.htm
...
// Time to string function found on github, sorry I cannot remember the source.
...
function getRgbTotal( $color ){
    $color = hex2rgb( $color ); 
    return array_sum($color);  
}
